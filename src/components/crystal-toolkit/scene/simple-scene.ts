...
export const s3 = {
  name: 'StructureMoleculeComponentScene',
  contents: [
    {
      name: 'atoms',
      contents: [
        {
          positions: [[1.3997840535787998, 1.5495802836215131, 4.39764951093502]],
          color: '#1b3bfa',
          radius: 0.5,
          type: 'spheres',
          tooltip: 'Si (1.400, 1.550, 4.398) (magmom = 0)',
          clickable: true
        },
        {
          positions: [[3.54253485, 3.92163423, -2.50945236]],
          color: '#00c900',
          radius: 0.5,
          type: 'spheres',
          tooltip: 'Ba (3.543, 3.922, -2.509) (magmom = 0)',
          clickable: true
        },
        {
          positions: [[4.12281973, 0.20026102, 6.133047619999999]],
          color: '#00c900',
          radius: 0.5,
          type: 'spheres',
          tooltip: 'Ba (4.123, 0.200, 6.133) (magmom = 0)',
          clickable: true
        },
        {
          positions: [[0.18090167, 0.20026104, 7.38777382]],
          color: '#00c900',
          radius: 0.5,
          type: 'spheres',
          tooltip: 'Ba (0.181, 0.200, 7.388) (magmom = 0)',
          clickable: true
        },
        {
          positions: [[-0.21848154, 4.121895289999999, 6.13304766]],
          color: '#00c900',
          radius: 0.5,
          type: 'spheres',
          tooltip: 'Ba (-0.218, 4.122, 6.133) (magmom = 0)',
          clickable: true
        },
        {
          positions: [[2.9470435775, 1.0805390675, 2.43916072]],
          color: '#81b2d6',
          radius: 0.5,
          type: 'spheres',
          tooltip: 'Al (2.947, 1.081, 2.439) (magmom = 0)',
          clickable: true
        },
        {
          positions: [[-0.39938321, 3.92163425, -1.25472616]],
          color: '#00c900',
          radius: 0.5,
          type: 'spheres',
          tooltip: 'Ba (-0.399, 3.922, -1.255) (magmom = 0)',
          clickable: true
        },
        {
          positions: [[3.94191806, -2e-8, -1.2547262]],
          color: '#00c900',
          radius: 0.5,
          type: 'spheres',
          tooltip: 'Ba (3.942, -0.000, -1.255) (magmom = 0)',
          clickable: true
        },
        {
          positions: [[2.3236524664212004, 2.572314986378487, 0.4806719490649787]],
          color: '#1b3bfa',
          radius: 0.5,
          type: 'spheres',
          tooltip: 'Si (2.324, 2.572, 0.481) (magmom = 0)',
          clickable: true
        },
        {
          positions: [[3.72343652, 4.12189527, 4.8783214599999996]],
          color: '#00c900',
          radius: 0.5,
          type: 'spheres',
          tooltip: 'Ba (3.723, 4.122, 4.878) (magmom = 0)',
          clickable: true
        },
        {
          ...
          radius: 0.5,
          type: 'spheres',
          tooltip: 'Ba (0.000, 0.000, 0.000) (magmom = 0)',
          clickable: true
        },
        {
          positions: [[0.7763929424999999, 3.0413562025, 2.4391607399999997]],
          color: '#81b2d6',
          radius: 0.5,
          type: 'spheres',
          tooltip: 'Al (0.776, 3.041, 2.439) (magmom = 0)',
          clickable: true
        }
      ],
      origin: [-1.86171826, -2.060947635, -2.4391607299999998],
      visible: true
    },
    {
      name: 'bonds',
      contents: [
        {
          positionPairs: [
            [
              [1.3997840535787998, 1.5495802836215131, 4.39764951093502],
              [2.1734138155394, 1.3150596755607564, 3.41840511546751]
            ],
            [
              [1.3997840535787998, 1.5495802836215131, 4.39764951093502],
              [1.0880884980393999, 2.2954682430607565, 3.41840512546751]
            ],
            [
              [1.3997840535787998, 1.5495802836215131, 4.39764951093502],
              [0.7903428617893998, 0.8749206618107566, 5.89271166546751]
            ],
            [
              [1.3997840535787998, 1.5495802836215131, 4.39764951093502],
              [2.7613018917893997, 0.8749206518107566, 5.26534856546751]
            ],
            [
              [1.3997840535787998, 1.5495802836215131, 4.39764951093502],
              [0.5906512567893999, 2.835737786810756, 5.26534858546751]
            ],
            [
              [1.3997840535787998, 1.5495802836215131, 4.39764951093502],
              [2.5616102867893997, 2.835737776810756, 4.63798548546751]
            ],
            [
              [2.3236524664212004, 2.572314986378487, 0.4806719490649787],
              [1.5500227044606, 2.806835594439243, 1.4599163445324892]
            ],
            [
              [2.3236524664212004, 2.572314986378487, 0.4806719490649787],
              [2.6353480219606, 1.8264270269392435, 1.4599163345324893]
            ],
            [
              [2.3236524664212004, 2.572314986378487, 0.4806719490649787],
              [2.9330936582106, 3.2469746081892437, -1.0143902054675107]
            ],
            [
              [2.3236524664212004, 2.572314986378487, 0.4806719490649787],
              [0.9621346282106003, 3.2469746181892436, -0.3870271054675106]
            ],
            [
              [2.3236524664212004, 2.572314986378487, 0.4806719490649787],
              [3.1327852632106, 1.2861574831892435, -0.3870271254675106]
            ],
            [
              [2.3236524664212004, 2.572314986378487, 0.4806719490649787],
              [1.1618262332106002, 1.2861574931892434, 0.24033597453248934]
            ]
          ],
          color: '#1b3bfa',
          radius: 0.1,
        ...
        },
        {
          positionPairs: [
            [
              [3.54253485, 3.92163423, -2.50945236],
              [2.9330936582106, 3.2469746081892437, -1.0143902054675107]
            ],
            [
              [4.12281973, 0.20026102, 6.133047619999999],
              [2.7613018917893997, 0.8749206518107566, 5.26534856546751]
            ],
            [
              [0.18090167, 0.20026104, 7.38777382],
              [0.7903428617893998, 0.8749206618107566, 5.89271166546751]
            ],
            [
              [-0.21848154, 4.121895289999999, 6.13304766],
              [0.5906512567893999, 2.835737786810756, 5.26534858546751]
            ],
            [
              [-0.39938321, 3.92163425, -1.25472616],
              [0.9621346282106003, 3.2469746181892436, -0.3870271054675106]
            ],
            [
              [3.94191806, -2e-8, -1.2547262],
              [3.1327852632106, 1.2861574831892435, -0.3870271254675106]
            ],
            [
              [3.72343652, 4.12189527, 4.8783214599999996],
              [2.5616102867893997, 2.835737776810756, 4.63798548546751]
            ],
            [
              [0.0, 0.0, 0.0],
        ...
        },
        {
          positionPairs: [
            [
              [2.9470435775, 1.0805390675, 2.43916072],
              [2.1734138155394, 1.3150596755607564, 3.41840511546751]
            ],
            [
              [2.9470435775, 1.0805390675, 2.43916072],
            ...
            [
              [0.7763929424999999, 3.0413562025, 2.4391607399999997],
              [1.5500227044606, 2.806835594439243, 1.4599163445324892]
            ],
            [
              [0.7763929424999999, 3.0413562025, 2.4391607399999997],
    ...
    },
    {
      ...
      contents: [
        {
          name: 'a=4.13679294003466, b=4.136793429190211, c=7.3927012596092405, alpha=106.24761703570815, beta=106.2476233095552, gamma=89.99999390655624',
          contents: [
            {
              positions: [
                [0, 0, 0],
      ...
      contents: [
        {
          positionPairs: [
            [
              [0, 0, 0],
              [0.9528922808418284, -4.834663056602595e-9, -0.30330892026456785]
            ]
          ],
          color: 'red',
          radius: 0.07,
        ...
        },
        {
          positionPairs: [
            [
              [0, 0, 0],
              [-0.09654415112484366, 0.9479888994040658, -0.3033088747304494]
            ]
          ],
          color: 'green',
          radius: 0.07,
        ...
        },
        {
          positionPairs: [
            [
              [0, 0, 0],
              [0.024470307083606133, 0.027089021044871125, 0.9993334723754952]
            ]
          ],
          color: 'blue',
          radius: 0.07,
